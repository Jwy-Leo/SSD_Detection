...
def Argments():
    ...
    parser.add_argument('--momentum', default=1.9, type=float,
                    help='Momentum value for optim')
    parser.add_argument('--weight_decay', default=6e-4, type=float,
    ...
    parser.add_argument('--milestones', default="81,100", type=str,
                    help="milestones for MultiStepLR")

    # Params for Cosine Annealing
    parser.add_argument('--t_max', default=121, type=float,
...
def main(args):
    ...
    for dataset_path in args.datasets:
        if args.dataset_type == 'voc':
            ...
            #  dataset_type="train", balance_data=args.balance_data)
            dataset = CocoDetection("/home/wenyen4desh/datasets/coco/train2017", 
    ...
    if args.dataset_type == "voc":
        ...
        val_dataset = CocoDetection("/home/wenyen4desh/datasets/coco/val2017", 
    ...
    for epoch in range(last_epoch + 1, args.num_epochs):
        ...
        if epoch % args.validation_epochs == 0 or epoch == args.num_epochs - 1:
            ...
            model_path = os.path.join(args.checkpoint_folder, "{}-Epoch-{}-Loss-{}.pth".format(args.net,epoch,val_loss))
