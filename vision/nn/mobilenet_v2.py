...
class MobileNetV2(nn.Module):
    def __init__(self, n_class=1000, input_size=224, width_mult=1., dropout_ratio=0.2, use_batch_norm=True, onnx_compatible=False):
        ...
        for t, c, n, s in interverted_residual_setting:
            ...
            for i in range(n):
                if i == 0:
                    self.features.append(block(input_channel, output_channel, s,t, use_batch_norm=use_batch_norm,onnx_compatible=onnx_compatible))
                else:
                    self.features.append(block(input_channel, output_channel, 1,t, use_batch_norm=use_batch_norm,onnx_compatible=onnx_compatible))
        ...
        #self.fc1 =  nn.Linear(self.last_channel, n_class)
